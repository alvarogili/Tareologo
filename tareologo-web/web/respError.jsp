        ...
        <body>
            ...
            <div id="contenido">
                <center>
                    ...
                    <br>
                    <br>
                    <b style="font-size: 20px;color: red;">El responsable que desea borrar tiene tareas asociadas</b>    
                    <br>
                    <br>
                </center>                
                <center>                
                    <br>
                    <h:form>
                        <h:commandButton action="responsables" value="Volver a Responsables" />
                    </h:form>
                </center>
            </div>
        </body>
